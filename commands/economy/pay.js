...
try {
  let user2 = message.author
    ...
    let embed2 = new MessageEmbed()
      .setColor("RANDOM")
      .setDescription(`bruh, you cannot duplicate money in this bot....`);
    ...
    let embed5 = new MessageEmbed()
      .setColor("RANDOM")
      .setDescription(`You are poor for that`);
    ...
    let embed6 = new MessageEmbed()
      .setColor("GREEN")
      .setDescription(`💸 Success - You payed ${user.displayName} ${args[1]} coins 💸`);
