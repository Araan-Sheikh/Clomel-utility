...
module.exports = {
    ...
    run: async (bot, message, args) => {
        ...
        if (!args[0]) {
            ...
            embed.setDescription(` ${message.guild.me.displayName}\nServer Prefix Is \`${prefix}\`\n\nFor Help Related To A Particular Command Type -\n\`${prefix}help [command name] Or ${prefix}help [aliases]\`**`)
            ...
            embed.setDescription(stripIndents`**Server Prefix Is \`${prefix}\`**\n
