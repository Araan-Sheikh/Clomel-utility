    ...
    run: async (bot, message, args) => {
        try {
            ...
            if (memberInvites.size <= 0) {
                return message.channel.send(`**${member.displayName} didn't invite anyone to the server! smh**`, (member === message.member ? null : member));
  {}          }
            ...
            let embed = new Discord.MessageEmbed()
                ...
                .setDescription(`${member.displayName}\'s invites`)
                .addField("**Invites**", index)
